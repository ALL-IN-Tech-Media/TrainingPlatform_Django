...
urlpatterns = [
    ...
    path("get_project_training_tasks/", views.get_project_training_tasks, name="get_project_training_tasks"),
    ...
    path("insert_training_epoch_status/", views.insert_training_epoch_status, name="insert_training_epoch_status"),
